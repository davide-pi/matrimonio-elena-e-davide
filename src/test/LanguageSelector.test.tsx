...
describe('LanguageSelector Component', () => {
  ...
  it('shows language options on hover', () => {
    ...
    // Check that dropdown is initially invisible
    ...
    // Check that dropdown is now visible (in a real browser, this would be handled by CSS)
    // Since our JSDOM environment doesn't process CSS :hover, we can test the classes that would
    // be applied when hovered
