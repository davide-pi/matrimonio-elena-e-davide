...
export default {
  ...
  "calendar.location":
    "Agriturismo La Rondina, Via Sandrone, 231, Castelnuovo Fogliani PC",
  "rsvp.title": "RSVP",
  ...
  "gift.title": "Poi voleremo in Asia...",
  "gift.description":
